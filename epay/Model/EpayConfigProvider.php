...
class EpayConfigProvider implements ConfigProviderInterface
{
    /**
    ...
    public function getConfig()
    {
        ...
        if ($this->methods[$code]->isAvailable($this->checkoutSession->getQuote())) {
            $config = [];
            $config['payment'] = [];
            $config['payment']['epay']['redirectUrl'] = [];
            $config['payment']['epay']['redirectUrl'][$code] = $this->getMethodRedirectUrl($code);
        }
